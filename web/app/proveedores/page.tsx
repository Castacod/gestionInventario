...
export default function ProveedoresPage() {
  ...
  const filteredItems = items.filter((item) =>
    ...
    item.contacto.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <div className="space-y-8">
      ...
      >
        <div>
          ...
          <p className="text-gray-400 mt-2">Administra asociaciones y distribuidores</p>
        </div>
        <motion.button
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="text-left py-4 px-4 font-semibold text-gray-300">Empresa / Marca</th>
                <th className="text-left py-4 px-4 font-semibold text-gray-300">Contacto</th>
